...
class npc_titlevendor : public CreatureScript
{
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        {
            creature->MonsterSay("You allredy have this title", 0, player->GetGUID()); 
            player->CLOSE_GOSSIP_MENU();
            return true;
        }
        ...
        {
            creature->MonsterSay("You need more honor points", 0, player->GetGUID());
            player->CLOSE_GOSSIP_MENU();
            return true;
        }
        ...
        creature->MonsterSay("You got new title!", 0, player->GetGUID()); 
        player->CLOSE_GOSSIP_MENU();
        return true;
    }
